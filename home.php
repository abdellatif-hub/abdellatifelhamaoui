            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Travel</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">You will be able to find out all your information through this site. You will also be able to book a travel ticket to your destination.</h2>
                    </div>
                </div>
            </div>
        </header>
